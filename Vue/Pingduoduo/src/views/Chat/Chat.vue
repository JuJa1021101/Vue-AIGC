<template>
    ...
    <div class="container">
        ...
        <div class="container-greet">
            <span style="font-weight: bold;">Hi,我是拼夕夕购买助手,专为有选择困难症的人群服务</span><br>
            <span style="margin-top: 0.15rem;display: block;">祝愿您能找到心仪的商品哟。</span>
        </div>
        ...
        <ul class="dialogue">
            ...
            <li v-for="(msg, index) in messages " :key="index">
                ...
                <div v-if="msg.type === 'answer' && msg.isRaw === true" class="dialogue-answer__isRaw" >
                    <span v-html="parseUrl(msg.content)"></span>
                </div>
    ...
    <div class=" inputAndRecommend">
        ...
        <van-cell-group>
            <van-field v-model="newQuestion" center clearable placeholder="请输入您的想要的商品信息和预算或者是需求">
                <template #button>
...
import fetchData from '../../api/chatCoze.ts'
...
const submit = async () => {
    ...
    try {
        ...
        const temp = await fetchData(question);
        // console.log(temp, '-----------------------------------');
